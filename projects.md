...
For my econometrics class in senior year, I decided to focus on tackling the issue of income inequality by studying if increasing education spending and having higher school enrollment rates can combat the problem. I predicted that this would be the case and countries that invest more in education will have lower levels of income inequality.
